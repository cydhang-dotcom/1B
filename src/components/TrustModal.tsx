      ...
      <AnimatePresence mode="wait">
        {!isSuccess ? (
          <motion.div 
            ...
            className="w-full max-w-4xl bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 overflow-hidden relative z-10 flex flex-col md:flex-row border border-slate-100"
          >
            {/* Modal Aside */}
            <div className="w-full md:w-2/5 bg-slate-50 p-12 flex flex-col justify-center relative overflow-hidden shrink-0 border-r border-slate-100">
               ...
               <div className="relative z-10">
                 <div className="text-[10px] font-bold tracking-widest text-[#66CDB5] uppercase mb-6">BANBU ONE SERVICE</div>
                 <h3 className="text-3xl font-extrabold text-slate-900 leading-[1.2] mb-4">企业后台<br/>交给班步</h3>
            ...
            <div className="w-full md:w-3/5 p-12 relative">
              ...
              <h3 className="text-2xl font-extrabold text-slate-900 mb-8 text-center md:text-left mt-4 md:mt-0">托管我的企业</h3>
