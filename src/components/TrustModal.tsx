    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <AnimatePresence mode="wait">
        {!isSuccess ? (
          ...
          >
            {/* Modal Aside */}
            <div className="w-full md:w-2/5 bg-slate-50 p-8 sm:p-12 flex flex-col justify-center relative overflow-hidden shrink-0 border-r border-slate-100">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 border-t border-slate-200 pt-6 sm:pt-8">
            ...
            <div className="w-full md:w-3/5 p-8 sm:p-12 relative">
              <button
                onClick={onClose}
                className="absolute top-4 sm:top-6 right-4 sm:right-6 p-2 rounded-full hover:bg-slate-50 text-slate-400 transition-colors"
              >
                <X size={20} />
              </button>
