        ...
        <div className="bg-[#f8fafc] rounded-[3rem] p-12 lg:p-24 relative overflow-hidden border border-slate-100">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="inline-flex items-center justify-center h-14 px-8 rounded-full bg-white text-slate-600 font-medium text-lg border border-slate-200 hover:border-slate-300 hover:text-slate-900 transition-all">
                注册新的公司
              </button>
            </div>
          </div>
