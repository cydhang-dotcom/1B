      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, idx) => (
            <div key={idx} className="group p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] bg-white border border-slate-200 hover:border-slate-300 shadow-sm transition-colors duration-300 flex flex-col h-full relative overflow-hidden">
              <div className="mb-6 sm:mb-8 w-12 h-12 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center relative z-10">
                {service.icon}
              </div>
